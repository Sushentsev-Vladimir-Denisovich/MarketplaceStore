...
start_message_for_admin = "Бот готов к работе, ожидайте сообщений от пользователей.\n\nДля ответа используйте сообщение в формате 1234%текст, где 1234 - ID пользователя, которому нужно ответить, а текст - сообщение, которое необходимо отправить ему";
